  ...
  return (
    <div className="min-h-screen flex flex-col px-6 pt-10 pb-8 bg-darkBg">
      <div className="mb-6 flex items-center">
        ...
        <h1 className="text-xl font-black text-white ml-2">Mint Digital Collectible</h1>
      </div>
      ...
      {!minted ? (
              ...
              >
                {minting ? (
                  <span className="flex items-center gap-2">
                    ...
                    Minting Digital Collectible...
                  </span>
                ) : (
                  'Mint This Highlight as a Digital Collectible'
                )}
              </Button>
            )}

            <p className="text-gray-500 text-xs text-center px-4 leading-relaxed">
              This will create a unique Digital Collectible on the TON blockchain that proves your ownership of this football highlight moment.
            </p>
          </div>
        </div>
      ) : (
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">Digital Collectible Minted Successfully! 🎉</h2>
          <p className="text-gray-400 mb-6">Your football highlight is now preserved as a unique collectible on the blockchain</p>
